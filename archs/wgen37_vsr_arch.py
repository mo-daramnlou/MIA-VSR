...
class WGEN37VSR(nn.Module):
    def __init__(self, scale=4, in_channels=3, mid_channels=24, num_blocks=6, out_channels=3, integrate_channels=16):
        ...
        self.middle_conv2 = nn.Conv2d(mid_channels , mid_channels , kernel_size=3, padding=1)
        middle_layers1 = []
        for _ in range(int(num_blocks/2)-1):
...
if __name__ == '__main__':
    ...
    model = WGEN37VSR(mid_channels=24, num_blocks=6)
    model.eval()
    ...
    # edge_model.export("/content/MIA-VSR/assets/wgen37vsr6.tflite")