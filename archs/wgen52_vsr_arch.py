...
class WGEN52VSR(nn.Module):
    def __init__(self, scale=4, in_channels=3, mid_channels=24, num_blocks=4, out_channels=3, integrate_channels=16):
        ...
        self.mid_conv = nn.Conv2d(mid_channels, mid_channels, kernel_size=3, padding=1)
        middle_layers = []
        ...
        # Pre T convs
        self.ptconv2 = nn.Conv2d(mid_channels + 8, mid_channels, kernel_size=1)
        ...
        self.middle_conv_ds2 = nn.Conv2d(8, 8, kernel_size=3, padding=1)
        middle_layers_ds1 = []
    ...
    def forward(self, lqs):
        ...
        x_ds = self.relu(self.middle_conv_ds2(x_ds))
        ds_skip = x_ds
...
if __name__ == '__main__':
    ...
    model = WGEN52VSR(mid_channels=24, num_blocks=4)
    model.eval()
