...
class WGEN17VSR(nn.Module):
    def __init__(self, scale=4, in_channels=3, mid_channels=28, num_blocks=4, out_channels=3, integrate_channels=16):
        ...
        # T convs
        self.tconv1 = nn.Conv2d(mid_channels + 2 * integrate_channels, out_channels * (scale**2), kernel_size=3, padding=1)
...
if __name__ == '__main__':
    ...
    model = WGEN17VSR(mid_channels=28, num_blocks=4)
    model.eval()
