...
class WGEN54VSR(nn.Module):
    def __init__(self, scale=4, in_channels=3, mid_channels=24, num_blocks=4, out_channels=3, integrate_channels=16):
        ...
        """
        super(WGEN54VSR, self).__init__()
        self.scale = scale
        self.integrate_channels=integrate_channels

        # Feature extraction layer
        self.fea_conv = nn.Conv2d(in_channels + 8, mid_channels, kernel_size=3, padding=1)
...
if __name__ == '__main__':
    ...
    model = WGEN54VSR(mid_channels=24, num_blocks=4)
    model.eval()
    ...
    # edge_model.export("/content/MIA-VSR/assets/wgen50vsr4.tflite")