...
class WGEN43VSR(nn.Module):
    def __init__(self, scale=4, in_channels=3, mid_channels=24, mid_channels_ds=8, num_blocks=6, out_channels=3, integrate_channels=16):
        ...
        self.rconv = nn.Conv2d(mid_channels + mid_channels_ds, mid_channels, kernel_size=1)
...
if __name__ == '__main__':
    ...
    model = WGEN43VSR(mid_channels=24, num_blocks=6)
    model.eval()
