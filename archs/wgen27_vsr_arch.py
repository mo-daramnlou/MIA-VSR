...
class WGEN27VSR(nn.Module):
    def __init__(self, scale=4, in_channels=3, mid_channels=24, num_blocks=6, out_channels=3, integrate_channels=16):
        ...
        self.ptconv4 = nn.Conv2d(mid_channels, mid_channels, kernel_size=3, padding=1)
        self.ptconv5 = nn.Conv2d(mid_channels, mid_channels, kernel_size=1)
    ...
    def forward(self, lqs):
        ...
        x = torch.cat([shifted_btx,ptx+feat_skip,shifted_atx],dim=1)
...
if __name__ == '__main__':
    ...
    model = WGEN27VSR(mid_channels=24, num_blocks=6)
    model.eval()
    ...
    # edge_model.export("/content/MIA-VSR/assets/wgen20vsr4.tflite")