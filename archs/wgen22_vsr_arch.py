...
class WGEN22VSR(nn.Module):
    def __init__(self, scale=4, in_channels=3, mid_channels=24, num_blocks=6, out_channels=3, integrate_channels=16):
        ...
        """
        super(WGEN22VSR, self).__init__()
        self.scale = scale
        self.integrate_channels=integrate_channels

        # Feature extraction layer
        self.fea_conv = nn.Conv2d(in_channels, 16, kernel_size=3, padding=1)
...
if __name__ == '__main__':
    ...
    model = WGEN22VSR(mid_channels=24, num_blocks=6)
    model.eval()
    ...
    # edge_model.export("/content/MIA-VSR/assets/wgen22vsr7.tflite")