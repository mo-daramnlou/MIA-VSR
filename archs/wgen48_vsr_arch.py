...
class WGEN48VSR(nn.Module):
    def __init__(self, scale=4, in_channels=3, mid_channels=24, num_blocks=4, out_channels=3, integrate_channels=24):
        """
        ...
        self.btconv3 = nn.Conv2d(mid_channels, mid_channels, kernel_size=3, padding=1)
        ...
        self.atconv3 = nn.Conv2d(mid_channels, mid_channels, kernel_size=3, padding=1)
...
if __name__ == '__main__':
    ...
    model = WGEN48VSR(mid_channels=24, num_blocks=4)
    model.eval()
