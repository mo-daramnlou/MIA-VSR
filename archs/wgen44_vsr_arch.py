...
class WGEN44VSR(nn.Module):
    ...
    def forward(self, lqs):
        ...
        ptx = self.relu(self.ptconv5(ptx + i_skip))
        ...
        btx = self.relu(self.btconv5(btx + i_skip))
        ...
        atx = self.relu(self.atconv5(atx + i_skip))
...
if __name__ == '__main__':
    ...
    model = WGEN44VSR(mid_channels=28, num_blocks=4)
    model.eval()
