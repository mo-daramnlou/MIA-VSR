...
class WGEN42VSR(nn.Module):
    def __init__(self, scale=4, in_channels=3, mid_channels=24, mid_channels_ds=8, num_blocks=6, out_channels=3, integrate_channels=16):
        """
    ...
    def forward(self, lqs):
        ...
        x_ds = self.middle_convs_ds2(x_ds+ feat_skip_ds)
...
if __name__ == '__main__':
    ...
    model = WGEN42VSR(mid_channels=24, num_blocks=6)
    model.eval()
