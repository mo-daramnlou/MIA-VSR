...
if __name__ == '__main__':
    ...
    model = WGEN51VSR(mid_channels=24, num_blocks=4)
    model.eval()
    ...
    # edge_model.export("/content/MIA-VSR/assets/wgen50vsr5.tflite")