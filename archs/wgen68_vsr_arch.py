...
class WGEN68VSR(nn.Module):
    def __init__(self, scale=4, in_channels=3, mid_channels=24, num_blocks=4, out_channels=3, integrate_channels=16, expand_size = 120):
        """
...
if __name__ == '__main__':
    ...
    model = WGEN68VSR(mid_channels=24, num_blocks=4)
    model.eval()
