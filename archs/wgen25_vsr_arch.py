...
class WGEN25VSR(nn.Module):
    def __init__(self, scale=4, in_channels=3, mid_channels1=16, mid_channels2=24, num_blocks=6, out_channels=3, integrate_channels1=8, integrate_channels2=16):
        ...
        """
        super(WGEN25VSR, self).__init__()
        self.scale = scale
        self.integrate_channels=integrate_channels2

        # Feature extraction layer
        self.fea_conv = nn.Conv2d(in_channels, mid_channels2, kernel_size=3, padding=1)

        # Middle convolutional layers1
        self.mconv1 = nn.Conv2d(mid_channels2, mid_channels1, kernel_size=3, padding=1)
...
if __name__ == '__main__':
    ...
    model = WGEN25VSR(mid_channels2=24, num_blocks=6)
    model.eval()
