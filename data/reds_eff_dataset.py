...
class REDSEffDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.kd_enabled and self.feature_hdf5 is not None:
            # save_folder = f'/home/mohammad/Documents/uni/deeplearning/FinalProject/inference_data/kd_train/'
            for neighbor in neighbor_list:
        ...
        # save_folder = f'/home/mohammad/Documents/uni/deeplearning/FinalProject/inference_data/kd_train2/'
