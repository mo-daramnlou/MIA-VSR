...
from archs.wgen7_vsr_arch import WGEN7VSR
from archs.wgen9_vsr_arch import WGEN9VSR
from archs.wgen10_vsr_arch import WGEN10VSR
from archs.wgen13_vsr_arch import WGEN13VSR
from archs.wgen14_vsr_arch import WGEN14VSR
from archs.wgen16_vsr_arch import WGEN16VSR
from archs.rgen2_vsr_infer_arch import RGEN2INFERVSR
from archs.rgen3_vsr_infer_arch import RGEN3INFERVSR
from archs.rgen4_vsr_infer_arch import RGEN4INFERVSR
...
def main(model_path):
    ...
    for i, (subfolder, subfolder_gt) in enumerate(zip(subfolder_l, subfolder_gt_l)):
        ...
        avg_psnr /= name_idx
        avg_ssim /= name_idx
        logger.info(f'Folder {subfolder_name} - PSNR: {avg_psnr:.6f} dB. SSIM: {avg_ssim:.6f}')
